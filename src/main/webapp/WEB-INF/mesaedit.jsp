...
<head>
    ...
    <link rel="stylesheet" href="/css/mesaedit.css">
</head>
<body>
    <div class="m-5 d-flex justify-content-center">
        <section class="tarjeta">
            <div class="d-flex justify-content-between">
                <h2 class="font-monospace">Edit Table</h2>
                <a href="/logout">Log out</a>
            </div>
            <p class="text-danger"><form:errors path="mesa.*"/></p>
            <form:form method="POST" action="/tables/${id}/edit" modelAttribute="mesa" class="form">
                ...
                <p class="form-group">
                    ...
                    <form:input path="invites" type="number" class="form-control"/>
                </p>
                <p class="form-group">
            ...
            <a href="/home" class="btn btn-success me-5">Cancel</a>
            <a href="/tables/${mesa.id}/delete" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar esta mesa?')">Delete Table</a>
        </section>
    </div>
