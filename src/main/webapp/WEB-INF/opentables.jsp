...
<body>
    <div class="m-5">
        <section class="d-flex justify-content-between">
            <h1>Open Tables</h1>
            <a href="/home" class="text-decoration-none fs-4 font-monospace">Home</a>
        </section>
        <p>Tables</p>
                ...
                <c:forEach items="${mesas}" var="mesa" >
                    <c:if test="${mesa.mesero == null}">
                        <tr>
                            ...
                            <td>
                                <p><a href="/${mesa.id}/assing" class="text-success text-decoration-none fs-5">Pickup Table</a></p>
                            </td>				
                        </tr>
                    </c:if>
                </c:forEach>
